...
"[project]/node_modules/@solana-mobile/mobile-wallet-adapter-protocol/lib/cjs/index.browser.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
var walletStandardUtil = __turbopack_context__.r("[project]/node_modules/@solana/wallet-standard-util/lib/cjs/index.js [app-client] (ecmascript)");
...
"[project]/node_modules/@solana-mobile/mobile-wallet-adapter-protocol-web3js/lib/esm/index.browser.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2d$mobile$2f$mobile$2d$wallet$2d$adapter$2d$protocol$2f$lib$2f$cjs$2f$index$2e$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@solana-mobile/mobile-wallet-adapter-protocol/lib/cjs/index.browser.js [app-client] (ecmascript)");
...
function transact(callback, config) {
    return __awaiter(this, void 0, void 0, function*() {
        ...
        return yield (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2d$mobile$2f$mobile$2d$wallet$2d$adapter$2d$protocol$2f$lib$2f$cjs$2f$index$2e$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["transact"])(augmentedCallback, config);
    });
}
function startRemoteScenario(config) {
    return __awaiter(this, void 0, void 0, function*() {
        const { wallet, close, associationUrl } = yield (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2d$mobile$2f$mobile$2d$wallet$2d$adapter$2d$protocol$2f$lib$2f$cjs$2f$index$2e$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startRemoteScenario"])(config);
...
"[project]/node_modules/@solana-mobile/wallet-standard-mobile/lib/cjs/index.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
var walletStandardFeatures = __turbopack_context__.r("[project]/node_modules/@solana/wallet-standard-features/lib/cjs/index.js [app-client] (ecmascript)");
var web3_js = __turbopack_context__.r("[project]/node_modules/@solana/web3.js/lib/index.browser.esm.js [app-client] (ecmascript)");
var QRCode = __turbopack_context__.r("[project]/node_modules/qrcode/lib/browser.js [app-client] (ecmascript)");
var features = __turbopack_context__.r("[project]/node_modules/@wallet-standard/features/lib/cjs/index.js [app-client] (ecmascript)");
var walletStandardChains = __turbopack_context__.r("[project]/node_modules/@solana/wallet-standard-chains/lib/cjs/index.js [app-client] (ecmascript)");
var mobileWalletAdapterProtocolWeb3js = __turbopack_context__.r("[project]/node_modules/@solana-mobile/mobile-wallet-adapter-protocol-web3js/lib/esm/index.browser.js [app-client] (ecmascript)");
var base58 = __turbopack_context__.r("[project]/node_modules/@solana-mobile/wallet-standard-mobile/node_modules/bs58/index.js [app-client] (ecmascript)");
...
class RemoteConnectionModal extends EmbeddedModal {
    ...
    populateQRCode(qrUrl) {
        ...
        return __awaiter(this, void 0, void 0, function*() {
            ...
            if (qrcodeContainer) {
                const qrCodeElement = yield QRCode__default["default"].toCanvas(qrUrl, {
                    width: 200,
                    margin: 0
                });
    ...
    constructor(config){
        ...
        _LocalSolanaMobileWalletAdapterWallet_signAndSendTransaction.set(this, (...inputs)=>__awaiter(this, void 0, void 0, function*() {
                ...
                for (const input of inputs){
                    ...
                    outputs.push({
                        signature: base58__default["default"].decode(signature)
                    });
                }
                return outputs;
            }));
...
"[project]/node_modules/@solana-mobile/wallet-adapter-mobile/lib/cjs/index.browser.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
var walletAdapterBase = __turbopack_context__.r("[project]/node_modules/@solana/wallet-adapter-base/lib/cjs/index.js [app-client] (ecmascript)");
var web3_js = __turbopack_context__.r("[project]/node_modules/@solana/web3.js/lib/index.browser.esm.js [app-client] (ecmascript)");
var walletStandardFeatures = __turbopack_context__.r("[project]/node_modules/@solana/wallet-standard-features/lib/cjs/index.js [app-client] (ecmascript)");
var walletStandardMobile = __turbopack_context__.r("[project]/node_modules/@solana-mobile/wallet-standard-mobile/lib/cjs/index.js [app-client] (ecmascript)");
/******************************************************************************
Copyright (c) Microsoft Corporation.
    ...
    signIn(input) {
        return __awaiter(this, void 0, void 0, function*() {
            return __classPrivateFieldGet(this, _BaseSolanaMobileWalletAdapter_instances, "m", _BaseSolanaMobileWalletAdapter_runWithGuard).call(this, ()=>__awaiter(this, void 0, void 0, function*() {
                    ...
                    try {
                        const outputs = yield __classPrivateFieldGet(this, _BaseSolanaMobileWalletAdapter_wallet, "f").features[walletStandardFeatures.SolanaSignIn].signIn(Object.assign(Object.assign({}, input), {
...
_BaseSolanaMobileWalletAdapter_wallet = new WeakMap(), _BaseSolanaMobileWalletAdapter_connecting = new WeakMap(), _BaseSolanaMobileWalletAdapter_readyState = new WeakMap(), _BaseSolanaMobileWalletAdapter_accountSelector = new WeakMap(), _BaseSolanaMobileWalletAdapter_selectedAccount = new WeakMap(), _BaseSolanaMobileWalletAdapter_publicKey = new WeakMap(), _BaseSolanaMobileWalletAdapter_handleChangeEvent = new WeakMap(), _BaseSolanaMobileWalletAdapter_instances = new WeakSet(), _BaseSolanaMobileWalletAdapter_connect = function _BaseSolanaMobileWalletAdapter_connect(autoConnect = false) {
    ...
    if (!__classPrivateFieldGet(this, _BaseSolanaMobileWalletAdapter_wallet, "f").isAuthorized || !__classPrivateFieldGet(this, _BaseSolanaMobileWalletAdapter_selectedAccount, "f")) throw new walletAdapterBase.WalletNotConnectedError();
...
//# sourceMappingURL=node_modules_%40solana-mobile_d5d8516a._.js.map